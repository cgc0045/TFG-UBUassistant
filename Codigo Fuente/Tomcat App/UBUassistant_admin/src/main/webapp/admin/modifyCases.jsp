...
<html>
	...
	<body>
		...
		if(request.getParameter("edit")!=null){
			...
			if(request.getParameter("keyWord6")!=null){
				if(!request.getParameter("keyWord6").equals("")){
					keyWords[5]=request.getParameter("keyWord6");
				}
			}
			if(request.getParameter("keyWord7")!=null){
				if(!request.getParameter("keyWord7").equals("")){
					keyWords[6]=request.getParameter("keyWord7");
				}
			}
		...
		<div class="divtable">
			...
			<thead>
			  ...
			  <th>Palabra clave 4</th><th>Palabra clave 5</th><th>Palabra clave 6</th><th>Palabra clave 7</th>
			  <th>Categoria</th><th>Respuesta</th><th>Acci&oacute;n</th></tr>
			</thead>
			<tbody>
		<%
			...
			%>
			  ...
			  <td><%=rs.getString("keyWord5") %></td><td><%=rs.getString("keyWord6") %></td>
			  <td><%=rs.getString("keyWord7") %></td><td><%=rs.getString("categoria") %></td>
			  ...
			  <td >
			  	...
			  	<form class="modifyForm" action="editCase.jsp;jsessionid=<%=session.getId()%>" method="POST">
			  		...
			  		<input type="hidden" name="keyWord6" value="<%=rs.getString("keyWord6") %>">
			  		<input type="hidden" name="keyWord7" value="<%=rs.getString("keyWord7") %>">
