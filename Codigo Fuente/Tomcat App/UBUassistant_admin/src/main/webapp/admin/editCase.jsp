...
<html>
	...
	<body>
		...
		if(request.getParameter("keyWord6")!=null){
			keyWord6=request.getParameter("keyWord6");
			if(keyWord6.equals("-")|| keyWord6.equals("null")){
				keyWord6="";
			}
		}
		if(request.getParameter("keyWord7")!=null){
			keyWord7=request.getParameter("keyWord7");
			if(keyWord7.equals("-")|| keyWord7.equals("null")){
				keyWord7="";
			}
		}
		  ...
		  <li class="breadcrumb-item actual">Editar Caso</li>
			...
			<form id="addForm" class="form-horizontal" action="modifyCases.jsp;jsessionid=<%=session.getId()%>" method="POST" onsubmit="return checkInput()">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="keyWord1">Palabra Clave 0:</label>
				    <div class="col-sm-10">
		    	...
		    	<div class="form-group">
					<label class="control-label col-sm-2" for="keyWord6">Palabra Clave 6:</label>
				    <div class="col-sm-10">
				    	<input id="keyWord6" class="form-control" type="text" name="keyWord6" value="<%=keyWord6 %>">
				    </div>
		    	</div>
		    	
		    	<div class="form-group">
					<label class="control-label col-sm-2" for="keyWord7">Palabra Clave 7:</label>
				    <div class="col-sm-10">
				    	<input id="keyWord7" class="form-control" type="text" name="keyWord7" value="<%=keyWord7 %>">
				    </div>
		    	</div>
