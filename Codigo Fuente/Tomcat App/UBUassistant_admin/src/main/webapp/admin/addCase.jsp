	...
	<body>
		...
		if(request.getParameter("keyWord6")!=null){
			if(!request.getParameter("keyWord6").equals("")){
				lista.add(request.getParameter("keyWord6"));
			}
		}
		if(request.getParameter("keyWord7")!=null){
			if(!request.getParameter("keyWord7").equals("")){
				lista.add(request.getParameter("keyWord7"));
			}
		}
		...
		<div id="content" class="content">
			...
			<form id="addForm" class="form-horizontal" action="addCase.jsp;jsessionid=<%=session.getId()%>" method="POST" onsubmit="return checkInput()">
		    	...
		    	<div class="form-group">
				    ...
				    <div class="col-sm-10">
				    	<input id="keyWord6" class="form-control" type="text" name="keyWord6">
				    </div>
		    	</div>
		    	...
		    	<div class="form-group">
				    ...
				    <div class="col-sm-10">
				    	<input id="keyWord7" class="form-control" type="text" name="keyWord7">
				    </div>
		    	</div>
