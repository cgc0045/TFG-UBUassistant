	...
	<body>
		...
		<div class="divtable">
			...
			<thead>
			  ...
			  <th>Palabra clave 5</th><th>Palabra clave 6</th><th>Palabra clave 7</th><th>Categoria</th><th>Respuesta</th><th>Numero de busquedas</th>
		...
		<%
			...
			%>
			  ...
			  <td><%=rs.getString("keyWord5") %></td><td><%=rs.getString("keyWord6") %></td><td><%=rs.getString("keyWord7") %></td><td><%=rs.getString("categoria") %></td><td class="resp"><%=rs.getString("respuesta") %></td>
