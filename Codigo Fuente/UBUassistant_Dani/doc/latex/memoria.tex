...
Concretamente, UBUassistant es capaz de orientar a un usuario de la página web de la Universidad de Burgos sin tener que navegar sobre el portal, si existe una respuesta concreta ésta será mostrada de manera inmediata, de lo contrario se otorgarán sugerencias para localizar la repuesta deseada. Basta con preguntar al asistente sobre algún apartado del sitio web.
