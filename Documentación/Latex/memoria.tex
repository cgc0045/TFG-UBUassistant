...
\newcommand{\nombre}{Carlos González Calatrava} %%% cambio de comando
...
\noindent Que el alumno D. \nombre, con DNI 71296090T, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado título de TFG. 
...
Actualmente vivimos en una sociedad en la que el gran porcentaje de las personas llevan consigo un \textit{smartphone} con el cual pueden acceder a una gran cantidad de información al instante. El problema radica en que muchas ocasiones, ciertas páginas web no están adaptadas de forma correcta a estos dispositivos, por lo que hace que dificulta la interacción con ellas.
...
Nowadays, we live in a society in which many people carry a smartphone is possible to use it to access to a lot of information instantly. Sometimes, this websites aren't adapted correctly to use it in smartphones so it's difficult to interact with them.

From this idea comes this UBUassistant second version, which allows that the assistant can be adapted to HTML5, iOS, Android, etc.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Virtual assistant, orientation in web portals, case based reasoning, tutored learning, Android application.
\end{abstract}
